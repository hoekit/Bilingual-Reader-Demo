...
mock.data_segmentList_alibaba = () => {
    return [
        ...
        {   id: 57,
            type: 'paragraph-start',
            text: 'When he got home he drove his asses into a small court,',
            tran: 'เมื่อเขากลับถึงบ้าน เขาก็ไล่ลาของเขาไปที่สนามเล็กๆ',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/57.mp3',
            image: 'img/2.jpg',
        ...
        {   id: 58,
            type: '',
            text: 'and shutting the gates carefully he took off the wood that covered the bags and carried them in to his wife.',
            tran: 'และหลังจากปิดประตูอย่างระมัดระวัง เขาก็เอาฟืนที่ปิดถุงและหามไปหาภรรยาของเขา',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/58.mp3'
        },
        {   id: 59,
            type: '',
            text: 'She, discovering them to be full of gold,',
            tran: 'เธอพบว่ามันเต็มไปด้วยทองคำ',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/59.mp3'
        },
        {   id: 60,
            type: '',
            text: 'feared that her husband had stolen them, and began sorrowfully to reproach him;',
            tran: 'กลัวว่าสามีของนางจะขโมยของพวกนี้ไปและเริ่มประณามเขาอย่างเศร้าใจ',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/60.mp3'
        },
        {   id: 61,
            type: '',
            text: 'but Ali Baba soon put her mind at rest on that score,',
            tran: 'แต่ในไม่ช้าอาลีบาบาก็รับรองกับเธอในเรื่องนี้',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/61.mp3'
        },
        {   id: 62,
            type: '',
            text: 'and having poured all the gold into a great heap upon the floor',
            tran: 'และหลังจากเททองทั้งหมดลงกองใหญ่บนพื้น',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/62.mp3'
        },
        {   id: 63,
            type: 'paragraph-stop',
            text: 'he sat down at her side to consider how well it looked.',
            tran: 'เขานั่งลงข้างเธอเพื่อพิจารณาว่ามันดูดีแค่ไหน ',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/63.mp3'
        },
        {   id: 64,
            type: 'paragraph-start',
            text: 'Soon his wife, poor careful body, must needs begin counting it over piece by piece.',
            tran: 'ในไม่ช้า ภรรยาของเขาผู้น่าสงสารก็ต้องเริ่มนับทีละชิ้น',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/64.mp3'
        },
        {   id: 65,
            type: '',
            text: 'Ali Baba let her go on for awhile, but before long the sight set him laughing.',
            tran: 'อาลีบาบาปล่อยเธอไปครู่หนึ่ง แต่ไม่นานการได้เห็นเธอแบบนั้นทำให้เขาหัวเราะ',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/65.mp3'
        },
        {   id: 66,
            type: '',
            text: '"Wife," said he, "you will never make an end of it that way.',
            tran: '"เมีย" เขาพูด "เจ้าจะไม่มีวันจบเรื่องนี้แน่',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/66.mp3'
        },
        {   id: 67,
            type: '',
            text: 'The best thing to do is to dig a hole and bury it,',
            tran: 'ทางที่ดีควรขุดหลุมฝังไว้',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/67.mp3'
        },
        {   id: 68,
            type: '',
            text: 'then we shall be sure that it is not slipping through our fingers."',
            tran: 'เราจึงมั่นใจได้ว่าจะไม่หลุดมือ"',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/68.mp3'
        },
        {   id: 69,
            type: '',
            text: '"That will do well enough," said his wife,',
            tran: '"นั่นเป็นสิ่งที่ดี" ภรรยาของเขาพูด',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/69.mp3'
        },
        {   id: 70,
            type: '',
            text: '"but it would be better first to have the measure of it.',
            tran: '"แต่เอาตัวมาวัดก่อนดีกว่า',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/70.mp3'
        },
        {   id: 71,
            type: '',
            text: "So while you dig the hole I will go round to Cassim's",
            tran: 'ดังนั้นในขณะที่คุณขุดหลุม ฉันจะไปร้าน Cassim',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/71.mp3'
        },
        {   id: 72,
            type: '',
            text: 'and borrow a measure small enough to give us an exact reckoning."',
            tran: 'และยืมหน่วยวัดขนาดเล็กพอที่จะให้เราคำนวณได้อย่างแม่นยำ"',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/72.mp3'
        },
        {   id: 73,
            type: '',
            text: '"Do as you will," answered her husband,',
            tran: '"ทำตามที่เจ้าต้องการ" สามีตอบ',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/73.mp3'
        },
        {   id: 74,
            type: 'paragraph-stop',
            text: '"but see that you keep the thing secret."',
            tran: '"แต่เธอเก็บความลับไว้นะ"',
            start: '00:00:',
            dura : '00:00:',
            src  : 'audio/74.mp3'
        },
...
mock.data_segmentList_MangalaSutta = () => {
    return [
        ...
        {   id: 7,
            type: 'paragraph-start',
            text: 'Bahu-saccan-ca sippan-ca  Vinayo ca susikkhito',
            tran: 'Broad knowledge, skill and discipline well-mastered;',
            src : 'audio/mgs7.mp3'
        },
        {   id: 8,
            type: 'paragraph-stop',
            text: 'Subhasita ca ya vaca  Etam mangala-muttamam',
            tran: 'Words well-spoken; This is the highest blessing.',
            src : 'audio/mgs8.mp3'
        },
        {   id: 9,
            type: 'paragraph-start',
            text: 'Mata pitu upatthanam  Putta darassa sangaho',
            tran: "Support for one's parents; Care for one's wife & children",
            src : 'audio/mgs9.mp3'
        },
        {   id: 10,
            type: 'paragraph-stop',
            text: 'Anakula ca kammanta  Etam mangala-muttamam',
            tran: 'All work completed well; This is the highest blessing.',
            src : 'audio/mgs10.mp3'
        },
        {   id: 11,
            type: 'paragraph-start',
            text: 'Danam-ca dhamma-cariya ca  Yatakanan-ca sangaho',
            tran: "Generosity, living by the Dhamma; Assistance to one's relatives",
            src : 'audio/mgs11.mp3'
        },
        {   id: 12,
            type: 'paragraph-stop',
            text: 'Anavajani kammani  Etam mangala muttamam',
            tran: 'Deeds that are harmless; This is the highest blessing.',
            src : 'audio/mgs12.mp3'
        },
        {   id: 13,
            type: 'paragraph-start',
            text: 'Arati virati papa  Majja-pana ca sannamo',
            tran: 'Avoiding, abstaining from unskilfulness; Refraining from intoxicants;',
            src : 'audio/mgs13.mp3'
        },
        {   id: 14,
            type: 'paragraph-stop',
            text: 'Appamado ca dhammesu  Etam mangala muttamam',
            tran: 'Being heedful in all occasions; This is the highest blessing.',
            src : 'audio/mgs14.mp3'
        },
        {   id: 15,
            type: 'paragraph-start',
            text: 'Garavo ca nivato ca santutthi ca katannuta;',
            tran: 'Respect, humility, contentment, filial piety;',
            src : 'audio/mgs15.mp3'
        },
        {   id: 16,
            type: 'paragraph-stop',
            text: 'Kalena dhammasavanam  Etam mangala muttamam',
            tran: 'Hearing the Dhamma on timely occasions; This is the highest blessing.',
            src : 'audio/mgs16.mp3'
        },
        {   id: 17,
            type: 'paragraph-start',
            text: 'Khanti ca sovacassata  Samananan ca dassanam',
            tran: 'Patience, composure, visiting comtemplatives;',
            src : 'audio/mgs17.mp3'
        },
        {   id: 18,
            type: 'paragraph-stop',
            text: 'Kalena dhamma-sakaccha  Etam mangala muttamam',
            tran: 'Discussing Dhamma on timely occasions; This is the highest blessing.',
            src : 'audio/mgs18.mp3'
        },
        {   id: 19,
            type: 'paragraph-start',
            text: 'Tapo ca brahma-cariyan ca  Ariya saccana dassanam',
            tran: 'Ardent striving, wholesome celibacy; Seeing the Noble Truths;',
            src : 'audio/mgs19.mp3'
        },
        {   id: 20,
            type: 'paragraph-stop',
            text: 'Nibbana sacchi kiriya ca  Etam mangala muttamam',
            tran: 'Realizing Unbinding; This is the highest blessing.',
            src : 'audio/mgs20.mp3'
        },
        {   id: 21,
            type: 'paragraph-start',
            text: 'Phutthasa loka-dhammehi  Cittam yassa na kampati',
            tran: 'A mind that, when touched by the ways of the world,',
            src : 'audio/mgs21.mp3'
        },
        {   id: 22,
            type: 'paragraph-stop',
            text: 'Asokam virajam khemam  Etam mangala muttamam',
            tran: 'is unshaken, sorrowless, dustless, secure; This is the highest blessing.',
            src : 'audio/mgs22.mp3'
        },
        {   id: 23,
            type: 'paragraph-start',
            text: 'Etadisani katvana  Sabbattham aparajita',
            tran: 'Fearless and secure anywhere when doing these things,',
            src : 'audio/mgs23.mp3'
        },
        {   id: 24,
            type: 'paragraph-stop',
            text: 'Sabbattha sotthim gacchanti  Tan tesam mangala muttamam-ti',
            tran: 'All beings can go forth everywhere in well-being. This is their highest blessing.',
            src : 'audio/mgs24.mp3'
        },
        /*
        {   id: ,
